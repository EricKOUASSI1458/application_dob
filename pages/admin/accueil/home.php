...
<div class="well well-lg">         
    <div class="row">
        <div class="col-md-12">
            ...
            <a  href="?p=client_admin" class="col-md-3 btn btn-xs btn-orange-ci">
                <h1 align="left"><?= $client->total_client ?><br></h1>
                <p>Clients</p>
            </a>
            <a  href="?p=prestataire_admin" class="col-md-3 btn btn-xs btn-default">
                <h1 align="left"><?= $prestataire->total_prestataire ?></h1>
                <p>Prestataires</p>
            </a>
            <a  href="?p=contrat_admin" class="col-md-3 btn btn-xs btn-orange-ci">
                <h1 align="left"><?= $contrat->total_actif()->total_contrat ?></h1>
                <p>Contrats</p>
            </a>
            <a href="?p=contrat_admin_list_encours" class="col-md-3 btn btn-xs btn-default">
                <h1 align="left">
    ...
    <div class="row">
        <div class="col-md-12" style="margin-top: 20px;">
            ...
            <a href="?p=contrat_admin_list_echue" class="col-md-3 btn btn-xs btn-default">
                <h1 align="left">
                    <?= $contrat->total_contrat_echu()->total_contrat_echu ?>
                </h1>
                <p>Contrats échus</p>
            </a>
            <a href="?p=contrat_admin_list_expirant_3_mois" class="col-md-3 btn btn-xs  btn-orange-ci">
                <h1 align="left">
                    <?= $contrat->total_contrat_echeant_dans_trois_mois()->total_contrat_echeant_dans_trois_mois ?>
                </h1>
                <p>Contrats expirant dans 3 mois</p>
            </a>
            <a href="?p=intervention_admin" class="col-md-3 btn btn-xs btn-default">
                <h1 align="left"><?= $intervention->total_actif()->total_intervention ?></h1>
                <p>Interventions</p>
            </a>

            <a href="?p=intervention.sans.contrat_admin" class="col-md-3 btn btn-xs  btn-orange-ci">
                <h1 align="left">
    ...
    <div class="row"  style="margin-top: 20px;">
        <div class="col-md-12">
            <a  href="?p=intervention_admin_realisee" class="col-md-3 btn btn-xs btn-orange-ci">
                <h1 align="left"><?= $intervention->total_realise()->total_realise ?><br></h1>

                <p>Interventions réalisées</p>
            </a>
            <a  href="?p=intervention_admin_a_venir" class="col-md-3 btn btn-xs btn-default">
                <h1 align="left"><?= $intervention->total_a_venir()->total_a_venir ?></h1>
                <p>Interventions à venir</p>
            </a>
            <a  href="?p=intervention_mois_courant" class="col-md-3 btn btn-xs btn-orange-ci">
                <h1 align="left">
